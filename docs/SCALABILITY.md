...
| OP-186 | **White-label / multi-brand?** | **Caminho decidido; ainda não provado de ponta a ponta.** Primitivos são domain-free e white-label-safe; a camada de produto (`product/`) concentra marca e domínio. White-label = trocar **accent** (camada semântica), **marca** (props) e **cópia** (`content.js`) sobre o **tema dark único** — não é troca de tema claro/escuro. Strings já externalizadas; falta a prova "app Fuel" de ponta a ponta (planejada). | ADR-0040 · `docs/white-label.md`, `docs/tokens-architecture.md`, `docs/ARCHITECTURE.md` (§camadas) · `ROADMAP_DS.md` Fase 3 (OP-010) |
| OP-187 | **Dark / Light?** | **Dark-only (decisão do owner, 2026-07-14).** O tema claro era um experimento abandonado e foi removido; Forge tem um **único tema escuro** grafite. Não há toggle claro/escuro nem dependência de `prefers-color-scheme`. Contraste do dark registrado em ADR-0050/0051. | ADR-0040 · `docs/tokens-architecture.md` · contraste registrado em ADR-0050, ADR-0051 · decisão dark-only (2026-07-14) |
