...
function ModuleChooserScreen({ onChoose }) {
  ...
  return (
    <div style={{ padding: "8px 20px 24px", maxWidth: 480, margin: "0 auto", boxSizing: "border-box" }}>
      ...
      <div style={{ fontFamily: "var(--forge-font-title)", fontSize: 30, textTransform: "uppercase", color: "var(--forge-text)", marginBottom: 22, lineHeight: "32px" }}>
      ...
      <div
        ...
        style={{ display: "flex", alignItems: "center", gap: 12, backgroundColor: "var(--forge-surface)", borderRadius: "var(--forge-radius-card)", border: "1px solid var(--forge-border)", padding: 14, marginTop: 14, cursor: "pointer" }}
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: "var(--forge-font-body)", fontWeight: 700, fontSize: 15, color: "var(--forge-text)" }}>Perfil</div>
          <div style={{ fontFamily: "var(--forge-font-body)", fontSize: 12.5, color: "var(--forge-text-dim)", marginTop: 1 }}>Sua conta, dados corporais e objetivo</div>
        </div>
...
function ModuleCard({ color, iconName, name, desc, onClick, Icon }) {
  return (
    <div
      onClick={onClick}
      style={{ display: "flex", backgroundColor: "var(--forge-surface)", borderRadius: "var(--forge-radius-card)", border: "1px solid var(--forge-border)", overflow: "hidden", cursor: "pointer" }}
    >
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 18, padding: 22, minWidth: 0 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontFamily: "var(--forge-font-title)", fontSize: 26, textTransform: "uppercase", color: "var(--forge-text)", lineHeight: "28px" }}>{name}</div>
          <div style={{ fontFamily: "var(--forge-font-body)", fontSize: 13, color: "#8a8a92", marginTop: 6, lineHeight: "18px" }}>{desc}</div>
        </div>
