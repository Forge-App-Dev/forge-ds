...
const COMPONENTS = [
  ...
  // Fase 4 — componentes ausentes
  ["Divider", "components/core/Divider.jsx"],
  ["Checkbox", "components/forms/Checkbox.jsx"],
  ["SegmentedControl", "components/forms/SegmentedControl.jsx"],
  ["PasswordField", "components/forms/PasswordField.jsx"],
  ["Slider", "components/forms/Slider.jsx"],
  ["FilterChip", "components/forms/FilterChip.jsx"],
  ["ProgressBar", "components/feedback/ProgressBar.jsx"],
  ["Badge", "components/feedback/Badge.jsx"],
  ["Avatar", "components/feedback/Avatar.jsx"],
  ["MacroRing", "components/feedback/MacroRing.jsx"],
  ["Timeline", "components/feedback/Timeline.jsx"],
  ["Tabs", "components/navigation/Tabs.jsx"],
  ["Accordion", "components/navigation/Accordion.jsx"],
  ["WeekStrip", "components/navigation/WeekStrip.jsx"],
