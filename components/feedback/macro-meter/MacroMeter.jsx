  ...
  if (compact) {
    return (
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <span style={{ color: "var(--forge-text-dim)", fontFamily: "var(--font-body)", fontWeight: 600, fontSize: 11, flexShrink: 0 }}>
    ...
    <div style={{ marginBottom: 10 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span style={{ color: "var(--forge-text-muted)", fontFamily: "var(--font-body)", fontWeight: 600, fontSize: 12.5 }}>{label}</span>
        </div>
        <span style={{ color: "var(--forge-text-dim)", fontFamily: "var(--font-body)", fontWeight: 600, fontSize: 12 }}>
