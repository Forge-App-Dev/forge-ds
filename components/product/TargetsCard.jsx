...
export const TargetsCard = React.forwardRef(function TargetsCard({
  ...
  return (
    <div ref={ref} className={className} style={{ backgroundColor: "var(--forge-surface)", border: "var(--forge-border-w) solid var(--forge-border)", borderRadius: "var(--forge-radius-card)", padding: "var(--forge-space-card)", ...style }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--forge-space-6)" }}>
...
function Stat({ label, value, unit = "", color }) {
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontFamily: "var(--forge-font-body)", fontSize: "var(--forge-text-mini-label)", color: "var(--forge-text-dim)", marginTop: "var(--forge-space-1)" }}>{label}</div>
    </div>
  );
}
